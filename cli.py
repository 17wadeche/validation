...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("requirements", type=Path, help="Path to requirements and guidance file")
...
def main() -> None:
    ...
    draft = agent.generate_draft(args.template, args.requirements, args.examples, args.code)
